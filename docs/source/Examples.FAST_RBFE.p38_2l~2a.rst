...
This test case demonstrates the alchemical perturbation between two p38 MAP kinase ligands, both in solution and when bound to protein. The optional '-e' flag enables enhanced sampling to explore the torsional rotations of the ligand's phenyl ring.
